  ...
  return (
    <section className="w-full h-screen relative">
      ...
      <main className="w-full h-full flex flex-col absolute top-0 left-0 bg-gray-900/50 z-10">
        ...
        >
          <ul
            className="flex gap-2 md:text-7xl text-5xl font-sans font-semibold relative z-10 before:content-[''] before:absolute before:left-0 before:bottom-2 before:bg-blue-700 before:w-full before:h-8 before:-z-10 after:content-[''] after:absolute after:left-0 after:bottom-0 after:bg-blue-700 after:w-full after:h-6 after:z-20 after:border-b after:border-gray-200 text-gray-200"
            id="animeText"
          >
          ...
          <button
            ...
            className="px-12 cursor-pointer border border-gray-100 rounded-lg outline-none transition-all duration-300  hover:bg-blue-900 text-base font-semibold py-2 bg-blue-700 text-gray-100"
          >
            Log In
          </button>
        </motion.div>
