  ...
  return (
    ...
    >
      <div className="md:flex md:h-20 items-center justify-between bg-gray-900 py-8 md:px-16 px-7">
        ...
        <ul
          className={`lg:flex lg:items-center lg:pb-0 pb-6 lg:static absolute bg-blue-700 lg:bg-transparent lg:z-auto z-[-1] left-0 w-full lg:w-auto lg:pl-0 pl-9 transition-all duration-700 ease lg:opacity-100 opacity-0 ${
        ...
        >
          ...
          <li className="lg:ml-6 ml-0 inline-block">
            <button
              ...
              className="text-sm font-semibold px-8 py-2 outline-none rounded-lg font-poppins text-blue-700 bg-gray-200 hover:bg-gray-400"
            >
              Logout
            </button>
          </li>
