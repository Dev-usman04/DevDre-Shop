...
const LoginForm = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center gap-4">
      <h1 className="text-blue-700 font-sans font-semibold text-2xl tracking-wider flex gap-1 items-center">
            ...
            <Form className="w-full flex flex-col justify-center gap-4">
              <div className="relative">
                ...
                <Field
                  ...
                  className={`bg-gray-200 rounded-lg transition-all duration-300 border border-gray-700 text-gray-800 outline-none text-sm focus:border-gray-800 block w-full pl-10 p-2.5 placeholder:text-gray-800 placeholder:font-light ${
                    errors.email && touched.email ? "border-blue-700" : null
                  }`}
              ...
              <div className="w-full mt-8 flex flex-col justify-center items-center gap-2">
                <button
                  ...
                  className="px-14 cursor-pointer border border-gray-100 rounded-lg outline-none transition-all duration-300  hover:bg-blue-900 text-base font-semibold py-2 bg-blue-700 text-gray-100 disabled:opacity-75 disabled:cursor-not-allowed"
                >
                  Submit
                </button>
              </div>
